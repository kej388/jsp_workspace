...
<a class="btn" href="BoardServlet?command=board_list&pageno=1">&lt;&lt;</a>
<a class="btn" href="BoardServlet?command=board_list&pageno=<%=prev_pageno%>">[이전]</a> 
<%for(int i =page_sno;i<=page_eno;i++){%>
	<a class="btn" href="BoardServlet?command=board_list&pageno=<%=i %>">
		<%if(pageno == i){ %>
			[<%=i %>]
		<%}else{ %>
			<%=i %>
...
<a class="btn" href="BoardServlet?command=board_list&pageno=<%=next_pageno%>" >[다음]</a>
<a class="btn" href="BoardServlet?command=board_list&pageno=<%=total_page %>">&gt;&gt;</a>